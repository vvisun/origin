...
var rpcRequestPool = usync.NewPoolEx(make(chan usync.IPoolData, 10240), func() usync.IPoolData {
	return &RpcRequest{}
})

var rpcCallPool = usync.NewPoolEx(make(chan usync.IPoolData, 10240), func() usync.IPoolData {
