...
var rpcJsonResponseDataPool = usync.NewPool(make(chan interface{}, 10240), func() interface{} {
	return &JsonRpcResponseData{}
})

var rpcJsonRequestDataPool = usync.NewPool(make(chan interface{}, 10240), func() interface{} {
